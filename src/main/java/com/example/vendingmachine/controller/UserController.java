...
public class UserController {
    ...
    @PostMapping
    public ResponseEntity<?> signUp(@Valid SignUpData signUpData) {
        User user = new User();
    ...
    @PreAuthorize("authentication.id == #userId")
    @PutMapping(value = "/{id}")
    ...
    public ResponseEntity<?> deleteUser(@PathVariable("id") Long userId) {
        //todo check products for sellers and rest of coins for buyers
